        ...
        <section className="bg-black py-12 md:py-24">
          <div className="container">
            <div className="flex flex-col space-y-8">
              {/* Back to Module Link */}
              <Link
                href={`/training/course/${course.slug}/module/${courseModule.slug}`}
                className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors"
              >
                <ArrowLeft className="h-4 w-4" />
                Back to {courseModule.moduleTitle}
              </Link>
          ...
          <div className="container">
            <div className="grid gap-8">
              ...
              <div className="flex justify-between">
                ...
                {nextLesson ? (
                  <Link
                    href={`/training/course/${course.slug}/module/${courseModule.slug}/lesson/${nextLesson.slug}`}
